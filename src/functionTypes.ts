...
//function with array
const ADDition = (num1: number, num2: number, num3: [number, number]) => {
    return (num1 + num2 + num3[0] + num3[1])
}
const result2 = ADDition(10, 20, [30, 20])

//optional chaining
const ADDITION = (num1: number, num2: number, num3?: number) => {
...
const Addition = (num1: number, num2: number, num3: number = 10) => {
